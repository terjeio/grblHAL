/*
  ...
  Serial stream driver code for Texas Instruments Tiva C (TM4C1294MCPDT) ARM processor
...
/*        } else {
    ...
    if(iflags & (UART_INT_RX|UART_INT_RT)) {
        ...
        } else if(!hal.protocol_process_realtime || hal.protocol_process_realtime((char)c)) {
