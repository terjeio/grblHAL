...
/** @ingroup EXAMPLES_USBDLIB_17XX40XX_CDC
 * @{
 */
...
#define USB_HS_MAX_BULK_PACKET  USB_FS_MAX_BULK_PACKET		/*!< MAXP for HS bulk EPs used for building USBD_Lib. DON'T CHANGE. */
